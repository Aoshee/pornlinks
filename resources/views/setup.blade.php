...
<div class="navbar navbar-default navbar-fixed-top">
    <a class="navbar-brand" href="/">PornLinks</a>
</div>
...
<div class="row" ng-controller="SetupCtrl" class="ng-root">
    ...
    <div class='col-md-6 setup-body well'>
        ...
        <form class='setup-form' method='POST' action='/setup'>
            ...
            <p>
                Database Name:
                <setup-tooltip content="Name of existing database. You must create the pornlinks database manually."></setup-tooltip>
            </p>
            <input type='text' class='form-control' name='db:name' value='pornlinks'>


            <h4>Application Settings</h4>

            <p>Application Name:</p>
            <input type='text' class='form-control' name='app:name' value='pornlinks'>

            <p>Application Protocol:</p>
            <input type='text' class='form-control' name='app:protocol' value='http://'>

            <p>Application URL (path to pornlinks; do not include http:// or trailing slash):</p>
            ...
            <p>
                Redirect URL:
                <setup-tooltip content="Required if you wish to redirect the index page or 404s to a different website. To use pornlinks, login by directly heading to yoursite.com/login first."></setup-tooltip>
            </p>
            ...
            <h4>
                ...
                <setup-tooltip content="These credentials will be used for your admin account in pornlinks."></setup-tooltip>
            </h4>

            <p>Admin Username:</p>
            <input type='text' class='form-control' name='acct:username' value='pornlinks'>

            <p>Admin Email:</p>
            <input type='text' class='form-control' name='acct:email' value='pornlinks@admin.tld'>

            <p>Admin Password:</p>
            <input type='password' class='form-control' name='acct:password' value='pornlinks'>
            ...
            <p>Theme (<a href='https://github.com/cydrobolt/pornlinks/wiki/Themes-Screenshots'>screenshots</a>):</p>
...
<div class='setup-footer well'>
    Pornlinks create by <a href='https://opensource.org/osd' target='_blank'>Aishee Nguyen</a> licensed under the <a href='//break.team'>Break
    License</a>.

    <div>
        Pornlinks Version {{env('VERSION')}} released {{env('VERSION_RELMONTH')}} {{env('VERSION_RELDAY')}}, {{env('VERSION_RELYEAR')}} -

        <div class='footer-well'>
            &copy; Copyright {{env('VERSION_RELYEAR')}}
            <a class='footer-link' href='//aishee.net' target='_blank'>Aishee Nguyen</a> &amp;
        </div>
    </div>
</div>
